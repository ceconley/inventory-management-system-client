...
$(() => {
  ...
  $('#index-items').on('click', itemEvents.onIndexItems)
  $('#create-item').on('submit', itemEvents.onCreateItem)
  $('#delete-item').on('submit', itemEvents.onShowForDeleteItem)
  ...
  $('#delete-confirm').on('click', '#delete-confirm-button', itemEvents.onDeleteItem)
})
